			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ href: 'https://github.com/cmu-isle/react-switch' },
							'React Switch'
						)
					),
					_react2.default.createElement(
...
},{"./../index.js":2,"react":167,"react-dom":31}],2:[function(require,module,exports){
'use strict';
...
var Switch = function (_React$Component) {
	...
	_createClass(Switch, [{
		...
		key: 'makeVisible',
		value: function makeVisible(element, index) {
			var o = index !== this.state.pos ? { style: { display: 'none' } } : { style: { display: 'inline' } };
			return _react2.default.cloneElement(element, o);
		}
	}]);
	...
	_createClass(Switch, [{
		key: 'render',
		value: function render() {
			var children = _react2.default.Children.map(this.props.children, this.makeVisible.bind(this));
			return _react2.default.createElement(
				'div',
				{ className: 'switch', onClick: this.handleClick.bind(this) },
				children
			);
		}
	}]);
...
},{"react":167,"react-dom":31}],3:[function(require,module,exports){
(function (process){
'use strict';
